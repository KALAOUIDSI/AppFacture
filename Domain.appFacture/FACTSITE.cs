...
namespace Domain.appFacture
{
    ...
    public partial class FACTSITE
    {
        public FACTSITE()
        {
            ...
            this.FACTDEMANDE1 = new HashSet<FACTDEMANDE>();
            this.FACTFACTURE = new HashSet<FACTFACTURE>();
            this.FACTFACTURE1 = new HashSet<FACTFACTURE>();
            this.FACTUSER = new HashSet<FACTUSER>();
            this.FACTUSER1 = new HashSet<FACTUSER>();
        }
        ...
        public virtual ICollection<FACTDEMANDE> FACTDEMANDE1 { get; set; }
        public virtual FACTENSEIGNE FACTENSEIGNE { get; set; }
        public virtual ICollection<FACTFACTURE> FACTFACTURE { get; set; }
        public virtual ICollection<FACTFACTURE> FACTFACTURE1 { get; set; }
        public virtual ICollection<FACTUSER> FACTUSER { get; set; }
        public virtual ICollection<FACTUSER> FACTUSER1 { get; set; }
    }
}
