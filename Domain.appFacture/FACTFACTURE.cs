...
namespace Domain.appFacture
{
    ...
    public partial class FACTFACTURE
    {
        public FACTFACTURE()
        {
            this.FACTFACTPIECEJOINTE = new HashSet<FACTFACTPIECEJOINTE>();
            this.FACTFACTUREDETAIL = new HashSet<FACTFACTUREDETAIL>();
        }
        ...
        public Nullable<decimal> MNTTVAPPRF { get; set; }
        public Nullable<decimal> TAUXTVAPPRF { get; set; }
    
        public virtual FACTCLIENT FACTCLIENT { get; set; }
        public virtual FACTDEMANDE FACTDEMANDE { get; set; }
        public virtual ICollection<FACTFACTPIECEJOINTE> FACTFACTPIECEJOINTE { get; set; }
        public virtual FACTSITE FACTSITE { get; set; }
        public virtual FACTTYPECLIENT FACTTYPECLIENT { get; set; }
        public virtual ICollection<FACTFACTUREDETAIL> FACTFACTUREDETAIL { get; set; }
