...
namespace Domain.appFacture
{
    public partial class FACTGROUPE
    {
        ...
        public FACTGROUPE(int id, string value)
        {
            this.IDGROUPE = id;
        ...
        public List<FACTGROUPE> getRestricted()
        {
            ...
            {
                IQueryable<FACTGROUPE> result = from c in DB.FACTGROUPE
                                                where c.LIBELLEGROUPE != "Siege Comptable" && c.LIBELLEGROUPE != "Admin"
                                            orderby c.LIBELLEGROUPE
                                            select c;
                return result.Include("FACTINTERFACE").ToList();
            }
        ...
        public List<FACTGROUPE> getAllDunInterface(string libelle)
        {
            using (EramEntities DB = new EramEntities())
            {
                IQueryable<FACTGROUPE> result = from c in DB.FACTGROUPE
                                                where c.FACTINTERFACE.Any(u=>u.LIBELLEINTERFACE==libelle)
                                                select c;
