    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                var aData = oTable.fnGetData(nRow);
                var jqTds = $('>td', nRow);
                jqTds[0].innerHTML = '<input type="text" class="form-control required" readonly="readonly" value="' + aData[0] + '">';
                jqTds[1].innerHTML = '<input type="text" class="form-control required" readonly="readonly" value="' + aData[1] + '">';
                jqTds[2].innerHTML = '<input type="text" class="form-control required" readonly="readonly" value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<input type="number" class="form-control required input-small " value="' + aData[3] + '">';
                jqTds[4].innerHTML = '<input type="number" readonly="readonly" class="form-control required input-small" value="' + aData[4] + '">';
                jqTds[5].innerHTML = '<input type="number" readonly="readonly" class="form-control required input-small" value="' + aData[5] + '">';
