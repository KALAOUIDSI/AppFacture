    ...
    return {
        ...
        init: function (cmp2) {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[3].innerHTML = cmp2.prop('outerHTML'); //'<input type="number" class="form-control required input-small" value="' + aData[3] + '">';
                if (aData[3].length > 0)
                    $("#TAUXTVA1").val(aData[3]);
            ...
            $('#sample_editable_1_new').click(function (e) {
                e.preventDefault();
                var aiNew = oTable.fnAddData(['', '1', '', '20',
