    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                var aData = oTable.fnGetData(nRow);
                var jqTds = $('>td', nRow);
                jqTds[0].innerHTML = '<input type="text" class="form-control readonly required" readonly value="' + aData[0] + '">';
                jqTds[1].innerHTML = '<input type="text" class="form-control readonly required" readonly value="' + aData[1] + '">';
                ...
                jqTds[4].innerHTML = '<input type="text" class="form-control readonly required" readonly value="0" >';
            ...
            jQuery('#sample_editable_3_wrapper .dataTables_filter').addClass("hidden");
            jQuery('#sample_editable_3_wrapper .dataTables_length').addClass("hidden");
            var nEditing = null;

            $('#sample_editable_3_new').click(function (e) {
                e.preventDefault();
                var aiNew = oTable.fnAddData(['','', '1', '', '0',
